...
public class TestExampleParser {
	...
	public void test_p1() {
		...
		assertThat(examples.get(1).input()).isEqualTo("nums = [3,2,4], target = 6");
		assertThat(examples.get(1).output()).isEqualTo("[1,2]");
		assertThat(examples.get(2).input()).isEqualTo("nums = [3,3], target = 6");
		assertThat(examples.get(2).output()).isEqualTo("[0,1]");
	}
